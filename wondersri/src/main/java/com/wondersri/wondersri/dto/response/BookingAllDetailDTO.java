...
public class BookingAllDetailDTO {
    ...
    // Constructor
    public BookingAllDetailDTO(Long id, String boatName, String userName, String userEmail,
                               String userPhone, LocalDate bookingDate, TimeSlot timeSlot,
                               String bookingCode, String status) {
        this.id = id;
